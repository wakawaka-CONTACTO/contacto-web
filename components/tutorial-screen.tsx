...
const tutorialSteps = [
  {
    ...
    content: (
      ...
      >
        <h1 className="text-6xl md:text-8xl font-mono text-white" style={{ fontFamily: "Press Start 2P, monospace" }}>
          LET'S
        </h1>
        <h1
      ...
      <div className="relative w-full aspect-[3/4]">
        <div className="absolute inset-0">
          <div className="relative h-full">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-white font-mono text-center">
              <div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <div className="mt-8 flex justify-center space-x-2">
          {tutorialSteps.map((_, index) => (
            <div key={index} className={`w-2 h-2 rounded-full ${index === currentStep ? "bg-white" : "bg-gray-600"}`} />
          ))}
        </div>
      </div>
