...
export function ChatRoom({ roomId }: ChatRoomProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f5dfdb]">
      ...
      {!connected && (
        <div className="bg-red-100 border border-gray-200 border-red-400 text-red-700 px-4 py-3 rounded relative dark:border-gray-800" role="alert">
          <strong className="font-bold">Connection Error!</strong>
          <span className="block sm:inline"> Unable to connect to the chat server. Please try again later.</span>
        </div>
      )}
